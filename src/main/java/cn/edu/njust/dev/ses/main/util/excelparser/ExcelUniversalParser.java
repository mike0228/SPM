                    ...
                    if(itemToColumnMap.containsValue(null)) {
                        ...
                        itemToColumnMap.forEach((key, value)->{
                            if(key.required&& value == null){
                                if(refnfe[0] == null) refnfe[0] = new RequiredExcelFieldNotFoundException("Cannot find required field.");
                    ...
                    if(pd != null) {
                        ...
                        if(writeMethod != null) {
                            ...
                            if(!propertyType.isAssignableFrom(String.class)){
                                if(cell == null|| (cell.getCellTypeEnum() != CellType.NUMERIC&& cell.getCellTypeEnum() != CellType.BOOLEAN&& (cell.getCellTypeEnum() == CellType.FORMULA && cell.getCachedFormulaResultTypeEnum() != CellType.NUMERIC))){
